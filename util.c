...
char *getTagString(unsigned int tag)
{
	switch(tag) {
		...
		case TAG_PRODUCTINFO:					return "TAG_PRODUCTINFO";
		...
		case TAG_DEBUGID:						return "TAG_DEBUGID";
		...
		case TAG_DOABC:							return "TAG_DOABC";
		case TAG_IMPORTASSETS2:					return "TAG_IMPORTASSETS2";
		case TAG_DEFINEFONTALIGNZONES:			return "TAG_DEFINEFONTALIGNZONES";
		case TAG_CSMTEXTSETTINGS:				return "TAG_CSMTEXTSETTINGS";
		case TAG_DEFINEFONT3:					return "TAG_DEFINEFONT3";
		case TAG_SYMBOLCLASS:					return "TAG_SYMBOLCLASS";
		case TAG_METADATA:						return "TAG_METADATA";
		case TAG_DEFINESCALINGGRID:				return "TAG_DEFINESCALINGGRID";
		case TAG_DOABC2:						return "TAG_DOABC2";
		case TAG_DEFINESHAPE5:					return "TAG_DEFINESHAPE5";
		case TAG_DEFINEMORPHSHAPE2:				return "TAG_DEFINEMORPHSHAPE2";
		case TAG_DEFINESCENEANDFRAMELABELDATA:	return "TAG_DEFINESCENEANDFRAMELABELDATA";
		case TAG_DEFINEBINARYDATA: 				return "TAG_DEFINEBINARYDATA";
		case TAG_DEFINEFONTNAME: 				return "TAG_DEFINEFONTNAME";
		case TAG_DEFINEFONT4:	 				return "TAG_DEFINEFONT4";
